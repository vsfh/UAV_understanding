...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/outputs/openclip_full_suite_e20_20g}"
RESULTS_ROOT="${RESULTS_ROOT:-${REPO_ROOT}/results/openclip_full_suite_e20_20g}"
CUDA_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"
ZERO_SHOT_BATCH_SIZE="${ZERO_SHOT_BATCH_SIZE:-16}"
LINEAR_BATCH_SIZE="${LINEAR_BATCH_SIZE:-256}"
LINEAR_FEATURE_BATCH_SIZE="${LINEAR_FEATURE_BATCH_SIZE:-32}"
FULL_BATCH_SIZE="${FULL_BATCH_SIZE:-2}"
FULL_GRADIENT_ACCUMULATION="${FULL_GRADIENT_ACCUMULATION:-8}"
